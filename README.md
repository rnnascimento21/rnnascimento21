...
### 🚀 Sobre Mim
- 💼 **Estagiário** na Prefeitura da Cidade do Rio de Janeiro, onde atuo no ciclo completo de desenvolvimento de aplicações.
- 🎓 Estudante de **Análise e Desenvolvimento de Sistemas (ADS)** - 2º período.
- 🎯 Focado em aprimorar habilidades em JavaScript, Node.js e bancos de dados SQL.
- 💡 Apaixonado por transformar desafios em código e entregar soluções que impactam usuários reais.
